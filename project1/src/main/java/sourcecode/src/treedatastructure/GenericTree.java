package sourcecode.src.treedatastructure;
...
import sourcecode.src.exception.NoneAlgorithmSpecifiedException;
import sourcecode.src.exception.TreeNotBalancedException;
...
public class GenericTree {
    ...
    public void backwardBFS1Step() throws NodeNotExistsException {
        if (traverseNode==null){
            return;
        }
    ...
    public void backwardDFS1Step() throws NodeNotExistsException {
        if (traverseNode==null){
            return;
        }
