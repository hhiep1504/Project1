...
import sourcecode.src.exception.*;
import sourcecode.src.screen.controller.operation.*;
...
public class GenericTreeController {
    ...
    @FXML
    protected void btnTraversePressed(ActionEvent event) throws TreeException {
        try {
    ...
    @FXML
    protected void backwardTraverseBtnPressed(ActionEvent e) throws NodeNotExistsException {
        if (algorithm.equals("BFS")) {
